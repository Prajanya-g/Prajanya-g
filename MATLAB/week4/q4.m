...
% that goes from white to black and saves it in the folder in png format.
...
for row=[1:numRows]
    ...
    imageRow=[]; 
    for col=[1:numCols]
        % making a pixel value that drecrease with each element in the column
        % from 1 - 0  
        pixelVal=(100 - col)/(imSize);
